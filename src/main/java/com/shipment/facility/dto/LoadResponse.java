...
public class LoadResponse {
    ...
    public LoadResponse(UUID loadId, FacilityRequest facility, String productType, String truckType, int noOfTrucks, double weight, String comment, UUID shipperId, LocalDate date) {
        this.loadId = loadId;
